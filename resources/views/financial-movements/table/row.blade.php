<tr class="even:bg-gray-50">
    ...
    @endif
    <td class="whitespace-nowrap px-3 py-2 text-sm text-gray-500">{{ $financial->date_formatted }}</td>
    ...
    <td class="whitespace-nowrap px-3 py-2 text-sm text-right {{ $financial->isDebit ? 'text-red-500' : 'text-green-500' }}">{{ $financial->amount_formatted }}</td>
